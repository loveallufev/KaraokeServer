...
class UberGallery {
    ...
    public function getColorboxStyles($themeNum) {
        ...
        return '<link rel="stylesheet" type="text/css" href="' . BASE_URL . DS . $colorboxPath . '" />';
    }
    ...
    public function getColorboxScripts() {
        ...
        $colorboxPath = BASE_URL . DS .  $this->_getRelativePath(getcwd(), $this->_appDir) . '/colorbox/jquery.colorbox.js';
